...
import { Users, Flag, Sparkles, FileText, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-dark-surface p-6 rounded-lg shadow-sm dark:border dark:border-dark-border transition-colors">
        <div className="flex items-start justify-between">
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">New Tickets</h3>
            <p className="text-3xl font-bold text-[#FD989D]">{stats.newTickets.toLocaleString()}</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Awaiting response</p>
          </div>
